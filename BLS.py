...
# BLS search: 30–290 days, coarse-to-fine refinement.
P_MIN, P_MAX = 30, 290
...
def clean(df):
    # Remove bad measurements, normalize by quarter, then detrend with a 1-day median.
...
def get_candidates(t, f):
    ...
    # Keep the strongest separated coarse peaks.
...
def harmonic(p1, p2):
    # Check common period aliases/harmonics.
...
def main():
    # Automatically process every .parquet file in DATA_DIR.
